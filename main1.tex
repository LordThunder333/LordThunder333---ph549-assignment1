...
\begin{enumerate}[label=(\alph*)]
    ...
    Total number of codons formed is $1546558$(Henceforth, referred to as $L$).
    Consider the following:
    There are $j$ stop codons. We get $j$ ORFs. 
    Also, the following equation must be satisfied:
    \begin{align}\sum_{i=1}^{j}x_{i} + y = L - j \; \forall j \in [0,L]\end{align}
    Here, $\bigcup_{i} \left\{x_{i}\right\}$ forms the set of lenghts of ORFs and $y$ is the tail. 
